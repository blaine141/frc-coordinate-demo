...
class SwerveModule:
    def __init__(
        ...
        self.driveEncoderSim = wpilib.simulation.EncoderSim(self.driveEncoder)
        self.turningEncoderSim = wpilib.simulation.EncoderSim(self.turningEncoder)
    ...
    def updateSimulation(self, period: float) -> None:
        if self.desiredState is not None:
            self.driveEncoderSim.setRate(self.desiredState.speed)
            self.driveEncoderSim.setDistance(self.driveEncoder.getDistance() + self.desiredState.speed * period)
            self.turningEncoderSim.setDistance(self.desiredState.angle.radians())
