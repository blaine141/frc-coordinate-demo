...
class Drivetrain:
    ...
    def updateSimulation(self, period: float) -> None:
        # Update simulation on SwerveModules
        self.backLeft.updateSimulation(period)
        self.backRight.updateSimulation(period)
        self.frontLeft.updateSimulation(period)
        self.frontRight.updateSimulation(period)
        ...
        self.gyroSim.setRate(chassisSpeeds.omega_dps)
        self.gyroSim.setAngle(self.gyro.getAngle() + self.gyro.getRate() * period)